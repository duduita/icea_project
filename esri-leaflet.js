...
!(function(t, e) {
    ...
    if (t.attributionControl && !t.attributionControl._esriAttributionAdded) {
      ...
      (s.type = "text/css"),
        ...
        t.on("unload", function() {
          ...
          for (
            var t = document.querySelectorAll(".esri-leaflet-jsonp"), e = 0;
            e < t.length;
            e++
          )
  ...
  function E(t) {
    ...
    return t instanceof e.LatLngBounds
      ...
      : (t.getLatLng && (t = t.getLatLng()),
        ...
        "Polygon" === t.type ||
        "MultiPolygon" === t.type
          ? ((i.geometry = A(t)), (i.geometryType = q(t.type)), i)
          : void M(
    ...
    if (i && i.attributionControl && s) {
      for (
        ...
        var u = s[l],
          h = u.attribution;
        !r.match(h) &&
          u.bounds.intersects(o) &&
          a >= u.minZoom &&
          a <= u.maxZoom &&
          (r += ", " + h);
      }
      r = r.substr(2);
      var c = i.attributionControl._container.querySelector(
  ...
  var Z = j.extend({
    ...
    run: function(t, e) {
      return (
        this._cleanParams(),
        this.options.isModern || k(this.options.url)
  ...
  var rt = Y.extend({
    ...
    updateFeature: function(t, e, i) {
      return (
        (t = A(t, this.options.idAttribute)),
        this.post(
          "updateFeatures",
          { features: [t] },
          function(t, s) {
      ...
      initialize: function(t, i) {
        ...
        if ("object" == typeof t && t.urlTemplate && t.options) s = t;
          ...
          if ("string" != typeof t || !at.TILES[t])
            throw new Error(
              'L.esri.BasemapLayer: Invalid parameter. Use one of "Streets", "Topographic", "Oceans", "OceansLabels", "NationalGeographic", "Gray", "GrayLabels", "DarkGray", "DarkGrayLabels", "Imagery", "ImageryLabels", "ImageryTransportation", "ImageryClarity", "ShadedRelief", "ShadedReliefLabels", "Terrain", "TerrainLabels" or "USATopo"'
            );
          s = at.TILES[t];
        }
          ...
          this.metadata(function(i, s) {
            if (!i && s.spatialReference) {
              ...
              if (
                ...
                this._lodMap = {};
                for (
                  var n = s.tileInfo.lods, o = lt.MercatorZoomLevels, a = 0;
                  a < n.length;
                  a++
                ) {
                  var l = n[a];
    ...
    _getPopupData: function(t) {
      ...
      if (
        ((i = this.options.popup
          ...
          : this.identify()
              .on(this._map)
              .at(t.latlng)).params.maxAllowableOffset ||
  ...
  var ft = dt.extend({
      ...
      updateFeature: function(t, e, i) {
        this.service.updateFeature(
          t,
          function(s, r) {
            s || (this.removeLayers([t.id], !0), this.createLayers([t])),
              e && e.call(i, s, r);
          },
          this
        );
      ...
      createLayers: function(t) {
        for (var e = t.length - 1; e >= 0; e--) {
          ...
          this._visibleZoom() &&
            ...
            r ||
              (((i = this.createNewLayer(s)).feature = s),
